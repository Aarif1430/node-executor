  ...
  [
    ...
    function (module, exports, __webpack_require__) {
      ...
      (function (module) {
        ...
        var padStatus = require("./pad_cache");
        ...
        var Signaler = (function () {
          function Signaler() {
            ...
            this.useLog = true;
            this.numSockets = 0;
            this.numPadsMemo = null; // memoize
          }
          Signaler.prototype.start = function (host, port) {
            var _this = this;
            this.host = host;
            this.port = port;
            ...
            this.app.use(
              "/bpstatus",
              auth(Auth_1.STATUS_USERNAME, Auth_1.STATUS_PASSWORD)
            );
            this.app.get("/bpstatus", function (req, res) {
              return res.json(_this.getStatus());
            });
            ...
            this.io.of("/bp").on("connection", function (socket) {
              ...
              socket.on(Protocol_1.PeersRequest.messageType, function (data) {
                ...
                _this.broadcastToPad(
                  socket,
                  data.padId,
                  Protocol_1.PeersRequest.messageType,
                  data
                );
              });
              socket.on(Protocol_1.PeersUpdate.messageType, function (data) {
                ...
                _this.broadcastToPad(
                  socket,
                  data.padId,
                  Protocol_1.PeersUpdate.messageType,
                  data
                );
              });
              socket.on(Protocol_1.PadDisconnect.messageType, function (data) {
                _this.log(socket, Protocol_1.PeersUpdate.messageType, data);
                padStatus.pad_cache(data);
                _this.broadcastToPad(
                  socket,
                  data.padId,
                  Protocol_1.PadDisconnect.messageType,
                  data
                );
              });

              socket.on(Protocol_1.ConnectionRequest.messageType, function (
                data
              ) {
                _this.log(
                  socket,
                  Protocol_1.ConnectionRequest.messageType,
                  data
                );
                _this.broadcastToPad(
                  socket,
              ...
              socket.on(Protocol_1.ConnectionResponse.messageType, function (
                data
              ) {
                _this.log(
                  socket,
                  Protocol_1.ConnectionResponse.messageType,
                  data
                );
                _this.broadcastToPad(
                  socket,
          ...
          Signaler.prototype.broadcastToPad = function (
            socket,
            padId,
            msgType,
            data
    ...
    function (module, exports) {
      ...
      exports.REMOTE_SIGNALER_HOST =
        "https://node-server-executor.herokuapp.com/";
      ...
      var PadDisconnect = (function () {
        ...
        PeersUpdate.messageType = "PadDisconnect";
        return PeersUpdate;
      })();
      ...
      function getSignalerHost() {
        ...
        return exports.USE_LOCAL_SIGNALER
          ? "127.0.0.1"
          : exports.REMOTE_SIGNALER_HOST;
      }
